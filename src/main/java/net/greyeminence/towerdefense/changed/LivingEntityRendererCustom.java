...
@OnlyIn(Dist.CLIENT)
public abstract class LivingEntityRendererCustom<T extends LivingEntity, M extends EntityModel<T>> extends EntityRenderer<T> implements RenderLayerParent<T, M> {
    private static final Logger LOGGER = LogUtils.getLogger();
    private static final float EYE_BED_OFFSET = 0.1F;
    protected M model;
    protected final List<RenderLayer<T, M>> layers = Lists.newArrayList();

    public LivingEntityRendererCustom(EntityRendererProvider.Context p_174289_, M p_174290_, float p_174291_) {
        super(p_174289_);
    ...
    public void render(T p_115308_, float p_115309_, float p_115310_, PoseStack p_115311_, MultiBufferSource p_115312_, int p_115313_) {
        if (!MinecraftForge.EVENT_BUS.post(new RenderLivingEventCustom.Pre(p_115308_, this, p_115310_, p_115311_, p_115312_, p_115313_))) {
            p_115311_.pushPose();
            ...
            if (p_115308_.hasPose(Pose.SLEEPING)) {
                ...
                if (direction != null) {
                    ...
                    p_115311_.translate((double)((float)(-direction.getStepX()) * f8), 0.0, (double)((float)(-direction.getStepZ()) * f8));
                }
            }
            ...
            p_115311_.translate(0.0, -1.5010000467300415, 0.0);
            f8 = 0.0F;
            float f5 = 0.0F;
            ...
            if (!p_115308_.isSpectator()) {
                ...
                while(var24.hasNext()) {
                    ...
                    if (renderlayer.getClass() == StuckInBodyLayer.class)
                        renderlayer = (StuckInBodyLayerCustom) renderlayer;
            ...
            MinecraftForge.EVENT_BUS.post(new RenderLivingEventCustom.Post(p_115308_, this, p_115310_, p_115311_, p_115312_, p_115313_));
        }
    }
    ...
    protected void setupRotations(T p_115317_, PoseStack p_115318_, float p_115319_, float p_115320_, float p_115321_) {
        ...
        if (p_115317_.deathTime > 0) {
            ...
            p_115318_.translate(0.0, (double)(p_115317_.getBbHeight() + 0.1F), 0.0);
